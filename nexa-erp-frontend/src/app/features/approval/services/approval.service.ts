...
export class ApprovalService {
  ...
  history(entityId:number):Observable<ApiResponse<ApprovalRequest[]>>{return this.http.get<ApiResponse<ApprovalRequest[]>>(`${this.url}/entity/MANUAL_JOURNAL/${entityId}/history`);}
